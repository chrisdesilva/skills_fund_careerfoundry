...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its UX, UI, and Web Development programs to help students build a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const programMaxText =
	'Choose the loan amount that works best for you. Borrow up to $9,900 for UX Design PLUS tuition, up to $6,900 for UX Design Certification or UI Design tuition, or up to $5,500 for Web Development tuition.';
