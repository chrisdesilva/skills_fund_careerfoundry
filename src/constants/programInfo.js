...
export const schoolInfo = {
  ...
  immediateRepayment: [
    ...
    {
      // for multiple examples of immmediate repayment, add items to immediateRepayment array
      programName: "the UX Design Program and UI Design Program",
      APR36: "12.36%",
...
export const headline =
  "Become a UX designer, UI designer, Web Developer, or Data Analyst with CareerFoundry" // update headline as appropriate

export const leadContent = {
  header: "Your last step on the path toward changing your career",
  paragraph: `${schoolName} designs its UX, UI, and Web Development programs to help students build a foundation for a career in software development. ${schoolName} partners with Skills Fund to offer tuition${
...
export const threeStepCardText = {
  ...
  step2: {
    ...
    text:
      "Choose between the UX Design PLUS Program, UX Design Program, Web Development Program, and UI Design Program.",
  },
...
export const programLoanInfo = [
  ...
  },
  {
    ...
    url: "https://my.skills.fund/application?lenderCode=SKCFWD18",
    loanInfo: {
      // match loanInfo in first metro below
      maxLoanAmt: 6900,
      loanTerm36: true,
...
export const programMaxText =
  "Choose the loan amount that works best for you. Borrow up to $9,900 for UX Design PLUS Program tuition, up to $6,900 for UX Design Program or UI Design Program tuition, or up to $6,900 for Web Development Program tuition."
